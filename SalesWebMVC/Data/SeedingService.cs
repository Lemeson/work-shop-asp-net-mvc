...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller( "Bob Browna", "boba@gmail.com", new DateTime(2000, 4, 22), 1000.0, d2);
            Seller s3 = new Seller( "Legacy Brown", "legacy@gmail.com", new DateTime(2022, 4, 21), 1000.0, d3);
            Seller s4 = new Seller( "Bob Star Wars", "star@gmail.com", new DateTime(1998, 4, 21), 1100.0, d4);
